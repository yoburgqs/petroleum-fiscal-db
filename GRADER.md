...
**Last Updated:** 2026-08-19 (Cycle 288 — FAQs A521-A525, Priority A/B/D UX improvements, v361)
**Grader Version:** 2.0
**Overall Status:** Cycle 288 shipped v361: FAQs A521-A525 (PSC cost recovery pool ring-fencing multi-block portfolios, Angola EPSA IV vs. Ghana Jubilee vs. Guyana Stabroek regime comparison, price-linked royalty relief 3 structural variants, PSC cost bank 60% cap IRR penalty, hybrid PSC-Concession blended take interpretation), Priority A Reference dropdown collapsed 6->4 items (API Explorer hidden), Priority B Home shortcut strip updated with Reform Risk navigation shortcut, Priority D Country Profile regional reform context injected below reform timeline, v360->v361 structural sweep (520->525 FAQs). JS syntax gate PASS / 6 blocks / 0 JS errors.
