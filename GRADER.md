...
**Last Updated:** 2026-08-14 (Cycle 178 — A132 pre-dev fiscal treatment + Load Top 5 shortcut + version sweep)
**Grader Version:** 2.0
**Overall Status:** Cycle 178 shipped v229: 3 improvements across 3 categories. Professional Credibility: A132 FAQ added — pre-development and appraisal-phase fiscal treatment (PSC vs. concession appraisal cost recovery; dry-hole cost asymmetry; Norway §5d 78% exploration refund; Indonesia PTK 007 POD approval gate; 4-step IC workflow; rule of thumb by cost type; FAQ count 131→132). Interaction Design: "Load Top 5 in Side-by-Side" button added to Fiscal Compare results hint bar — one-click shortcut to compare the top-ranked regimes without 5 individual clicks. Naming Consistency: v228→v229 sweep across all structural locations; Methodology card updated to 132 analyst FAQs. Tests: 4/4 JS syntax gate PASS / 0 JS errors (pre-commit verification).
...
| 5 | 2. Information Architecture | A+ | = | "Back to top" link at end of 132-FAQ section. Methodology card updated to 132 analyst FAQs (v229). First-visit Quick Start guide (v115). Landmark map complete (v104). |
