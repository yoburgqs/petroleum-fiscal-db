...
## Updated Grade Table (Cycle 136 — 2026-08-13)

| Rank | Category | Grade | Delta | Priority Fix |
|------|----------|-------|-------|-------------|
| 1 (lowest) | 8. Data Reliability | B+ | = | IRR coverage 74/185 — Harvesting fork issue. Grade cannot move above B+ until IRR coverage reaches ~120+. 92 FAQs (A1–A92) + proxy workflow + A13 source verification + A17 IC-readiness + A49–A92 advanced IC workflows (A92 adds farm-in/WI acquisition fiscal assessment — cost pool exhaustion, R-factor tier adjustment, 4-step validation workflow, IC memo template). Benchmark 185 countries (all unique) / 185/185 pass (100%) — MILESTONE: 100% DB coverage. Sources: 184. Documentation bug fixed: methodology table correctly says "Straight-line 7yr" matching actual DCF engine. |
...
| 5 | 2. Information Architecture | A+ | = | "Back to top" link at end of 92-FAQ section (v185). First-visit Quick Start guide (v115). Landmark map complete (v104). |
...
| 7 | 13. SDLC Maturity | A+ | = | Clean cycle. 4/4 script blocks OK / syntax gate PASS. CI badge present. |
| 8 | 10. Accessibility | A+ | = | IRR scatter chart aria-label fully descriptive (v120). All WCAG 2.1 AA landmarks complete. aria-live on #fc-status (v106). FAQ accordions A12–A92 accessible (querySelectorAll delegation picks up new FAQs automatically). FC sort row role=group (v112). Explorer aria-sort dynamic (v110). |
...
| 12 | 5. Naming Consistency | A+ | = | All naming unified. v184→v185 across all locations (Cycle 136). 26 stale v177 IC memo template citations corrected to v179 across FAQ bodies A59–A85 and How to Cite (v179). |
| 13 | 7. Professional Credibility | A+ | = | 92 FAQs (A1–A92) + "How to Cite" + A13 source verification + A17 IC-readiness + A49–A92 advanced IC workflows (A92 adds farm-in WI acquisition fiscal assessment — cost pool exhaustion adjustment, R-factor tier mechanics, 4-step validation, IC memo template). Benchmark 185 countries (all unique) / 185/185 pass (100%). Sources: 184. application-name meta (v120). |
| 14 | 14. Search Quality | A+ | = | Levenshtein edit distance. Recent searches with Clear button. |
| 15 (highest) | 15. Export / Shareability | A+ | = | XLSX, CSV, PDF, PNG across all tabs. How to Cite expanded with short-form footnote format and Scenario Builder citation guidance (v175). XLSX Citation metadata updated to v185. |

**Summary: 1 at B+. 0 at A-. 1 at A. 13 at A+. GPA: 3.97. Tests: 4/4 JS script blocks OK / syntax gate PASS / 0 JS errors. Playwright suite showing infrastructure crash (37 PASS / 15 FAIL on deployed v184 — "Target crashed" Chromium OOM; pre-existing, not caused by v185 changes). Cycle 136 grade changes: Professional Credibility A+ maintained — 92 FAQs (A92 farm-in/WI acquisition: cost pool exhaustion, R-factor tier adjustment, 4-step validation workflow). Naming Consistency A+ maintained — v184→v185 version bump. Data Reliability B+ maintained — IRR structural gap (74/185) binding constraint unchanged.**
