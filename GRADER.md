...
**Last Updated:** 2026-08-10 (Cycle 67 — autonomous improvement cycle)
**Grader Version:** 2.0
**Overall Status:** Cycle 67 shipped v114: 5 targeted improvements. Data Reliability: A22 FAQ added (evidence-coverage orthogonality); benchmark expanded 33→35 countries (Ecuador + Libya, 34/35 pass 97%, coverage 18.9%). Interaction Design: Alt+← / Alt+→ keyboard shortcuts for tab cycling. Mobile: iOS auto-zoom prevention (font-size:16px on select at 768px). Methodology: Print/Save PDF button added to Methodology tab header. Tests: 118 PASS / 0 FAIL / 15 WARN / 0 JS errors (Playwright full run).
