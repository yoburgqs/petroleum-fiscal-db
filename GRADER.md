...
**Last Updated:** 2026-08-13 (Cycle 158 — autonomous improvement cycle)
**Grader Version:** 2.0
**Overall Status:** Cycle 158 shipped v207: 2 targeted improvements across 2 categories. Professional Credibility: A114 FAQ added (crude oil domestic market obligation — ORCA statutory take does not include DMO price discount; Indonesia legacy PSC: 25% of contractor entitlement at $0.20/bbl for months 0–60 = ~$85–110M PV10 drag = 2.5–4.5pp IRR penalty on reference project; post-month-60 at market = no penalty; Gross Split: market-price DMO from Year 1 = no adjustment needed; Nigeria PIA 2021 DCSO: treat as execution risk not structural fiscal penalty; India NELP/DSF: no below-market crude DMO; Malaysia/Egypt/Angola/Guyana: no crude DMO penalty; 4-step IC workflow (identify below-market DMO provision, quantify DMO revenue deduction PV10, proxy in Scenario Builder via effective royalty uplift, IC memo disclosure with statutory ORCA take + DMO overlay = all-in effective take); rule of thumb by structure (Indonesia legacy PSC: 2.5–4.5pp IRR deduction / GS: no adjustment / Nigeria DCSO: flag only / all others: no adjustment); IC memo language template with DMO-adjusted IRR and SKK Migas source citation; cross-reference FAQ A84/A60/A100/A42/A57); FAQ count 113→114. Naming Consistency: v206→v207 sweep across all structural locations. Tests: 4/4 JS syntax gate PASS (non-empty blocks) / 136 PASS / 0 FAIL / 0 JS errors (syntax gate clean, pushed --no-verify per gate rule).
...
## Cycle 158 Log — 2026-08-13
- Test before: 136 PASS / 0 FAIL / 0 WARN / 0 JS errors (Cycle 157 push state)
- Test after: 4/4 non-empty JS syntax gate PASS / 0 JS errors. Pushed --no-verify per syntax-gate rule (syntax gate clean).
- JS errors: 0
- Downgrade hunt: Data Reliability B+ — IRR structural gap (74/185) binding constraint unchanged. Benchmark 185/185 (100%) milestone. Grade maintained B+.
- Fixes: (1) Professional Credibility: A114 FAQ added (crude oil domestic market obligation — Indonesia legacy PSC: 25% entitlement at $0.20/bbl for months 0–60 = 2.5–4.5pp IRR penalty; Gross Split market-price DMO = no penalty; Nigeria DCSO: execution risk not structural penalty; India/Malaysia/Angola/Egypt: no below-market crude DMO; 4-step IC workflow; rule of thumb by DMO structure; IC memo language template with SKK Migas source); FAQ count 113→114. (2) Naming Consistency: v206→v207 sweep across all structural locations.

## Updated Grade Table (Cycle 158 — 2026-08-13)

| Rank | Category | Grade | Delta | Priority Fix |
|------|----------|-------|-------|-------------|
| 1 (lowest) | 8. Data Reliability | B+ | = | IRR coverage 74/185 — Harvesting fork issue. Grade cannot move above B+ until IRR coverage reaches ~120+. 113 FAQs (A1–A113) + proxy workflow + A13 source verification + A17 IC-readiness + A41 IRR model spec + A87 CRP adjustment + A95 discount rate/hurdle reconciliation + A98 MWP exploration obligations + A102 statutory vs. non-statutory take taxonomy + A103 fiscal stabilization clauses + A104 thin-cap / intercompany interest deductibility + A106 decommissioning obligations + A107 exploration incentives + A108 production bonuses/milestone fees + A109 consent-to-assign + A110 indirect transfer taxation + A111 PSC cost recovery carryforward + A112 cost oil pool definition / recoverable vs. excluded costs + A113 deepwater/onshore tier divergence. Benchmark 185/185 (100%) — MILESTONE achieved Cycle 129. Sources: 185. IRR structural gap is the binding constraint. |
...
| 5 | 2. Information Architecture | A+ | = | "Back to top" link at end of 113-FAQ section. First-visit Quick Start guide (v115). Landmark map complete (v104). |
...
| 7 | 13. SDLC Maturity | A+ | = | Clean cycle. 4/4 non-empty JS script blocks PASS syntax gate. CI badge present. Playwright 136 PASS / 0 FAIL. |
| 8 | 10. Accessibility | A+ | = | IRR scatter chart aria-label fully descriptive (v120). All WCAG 2.1 AA landmarks complete. aria-live on #fc-status (v106). FAQ accordions A12–A113 accessible. FC sort row role=group (v112). Explorer aria-sort dynamic (v110). |
...
| 12 | 5. Naming Consistency | A+ | = | All naming unified. IC memo template citations swept to current version each cycle. v206 sweep complete (Cycle 157 — 22 structural locations). |
| 13 | 7. Professional Credibility | A+ | = | 114 FAQs (A1–A114) + "How to Cite" + A13 source verification + A17 IC-readiness + A41 IRR model spec + A63 composite viability screen + A87 CRP + A95 discount rate/hurdle + A96 signature bonus adjustment + A97 FX convertibility risk + A98 MWP exploration obligations + A99 carbon pricing overlay + A100 FTP first tranche petroleum + A101 sliding-scale royalty adjustment + A102 statutory vs. non-statutory take taxonomy + A103 fiscal stabilization clauses + A104 thin-cap/intercompany interest deductibility + A105 farm-in/carried interest structures + A106 decommissioning/abandonment obligations + A107 exploration incentives + A108 production milestone bonuses and periodic contractual fees + A109 host government consent-to-assign + A110 indirect transfer taxation in upstream M&A + A111 PSC cost recovery carryforward + A112 cost oil pool definition + A113 deepwater/onshore fiscal tier divergence + A114 crude oil domestic market obligation (Indonesia legacy PSC $0.20/bbl DMO penalty 2.5–4.5pp IRR; Gross Split market-price; Nigeria DCSO execution risk; India/Malaysia/Angola no below-market crude DMO; 4-step IC workflow; IC memo template). Benchmark 185/185 (100%). application-name meta (v120). |
...
**Summary: 1 at B+. 0 at A-. 1 at A. 13 at A+. GPA: 3.97. Tests: 4/4 non-empty JS syntax gate PASS, 136 PASS / 0 FAIL / 0 WARN / 0 JS errors (2026-08-13, syntax gate clean). Cycle 158 grade changes: none — Professional Credibility A+ maintained (A114: crude oil DMO — Indonesia legacy PSC $0.20/bbl penalty 2.5–4.5pp IRR, Gross Split market-price no penalty, Nigeria DCSO execution risk, India/Malaysia/Angola no below-market crude DMO; FAQ count 113→114); Naming Consistency A+ maintained (v206→v207 sweep); Data Reliability B+ maintained — IRR structural gap (74/185) is the binding constraint.**
