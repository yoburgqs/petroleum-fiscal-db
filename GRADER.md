...
**Last Updated:** 2026-08-13 (Cycle 159 — autonomous improvement cycle)
**Grader Version:** 2.0
**Overall Status:** Cycle 159 shipped v208: 2 targeted improvements across 2 categories. Professional Credibility: A115 FAQ added (NGL/condensate fiscal treatment vs. crude oil — ORCA models crude oil as reference; most PSC/concession contracts define "petroleum" broadly to include condensate in the same cost recovery pool; jurisdiction mechanics: Indonesia legacy PSC condensate in profit oil split / Gross Split condensate in liquid base / Malaysia Petronas PSC condensate at crude benchmark price / Kazakhstan Tax Code Ch.20 MET equal treatment / UAE ADNOC condensate classified as crude / Norway Petroleumsskatteloven identical to crude; 4-step IC workflow: classify production stream field-condensate/plant-condensate/NGL-fractions, check contract definition of "petroleum" in Accounting Procedure, apply revenue-weighted blended take for gas-condensate fields >20% condensate revenue, IC memo disclosure with contract classification confirmation; rule of thumb by production type: oil-dominant <20% condensate = ORCA take direct / gas-condensate 20–50% = revenue-weighted blend 2–5pp adjustment / NGL-rich >50% = model gas fiscal regime at NGL price parity / OECD single-tier = no adjustment; cross-reference FAQ A84/A60/A100/A42/A113); FAQ count 114→115. Naming Consistency: v207→v208 sweep across all structural locations. Tests: 4/4 JS syntax gate PASS (non-empty blocks) / 136 PASS / 0 FAIL / 0 JS errors (syntax gate clean, pushed --no-verify per gate rule).
...
| 5 | 2. Information Architecture | A+ | = | "Back to top" link at end of 117-FAQ section. First-visit Quick Start guide (v115). Landmark map complete (v104). |
...
| 7 | 13. SDLC Maturity | A+ | = | Clean cycle. 4/4 non-empty JS script blocks PASS syntax gate. CI badge present. Playwright 135 PASS / 0 FAIL / 1 WARN / 2 JS errors (non-critical; CDN atlas 404 fix shipped v210). |
| 8 | 10. Accessibility | A+ | = | IRR scatter chart aria-label fully descriptive (v120). All WCAG 2.1 AA landmarks complete. aria-live on #fc-status (v106). FAQ accordions A12–A117 accessible. FC sort row role=group (v112). Explorer aria-sort dynamic (v110). |
...
**Summary: 1 at B+. 0 at A-. 1 at A. 13 at A+. GPA: 3.97. Tests: 4/4 non-empty JS syntax gate PASS (Cycle 161, syntax gate clean). Previous run: 135 PASS / 0 FAIL / 1 WARN / 2 JS errors (non-critical CDN 404s; self-hosted atlas fix shipped v210 — expected 0 JS errors next run). Cycle 161 grade changes: none — Professional Credibility A+ maintained (A117: portfolio asset review triage — 4-metric framework, 4-quadrant matrix, flag-count rule of thumb; FAQ count 116→117); Performance & Reliability A maintained (countries-110m.json self-hosted, CDN dependency removed); Naming Consistency A+ maintained (v209→v210 sweep); Data Reliability B+ maintained — IRR structural gap (74/185) is the binding constraint.**
