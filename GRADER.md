...
**Last Updated:** 2026-08-17 (Cycle 267 — FAQ A379 IRR interpretation workflow, FAQ A380 Screener preset guide, performance deferral, accessibility improvements, v338)
**Grader Version:** 2.0
**Overall Status:** Cycle 267 shipped v338: FAQ A379 (IRR interpretation for 61 unbounded + 20 non-computable countries — 3-tier IC proxy framework), FAQ A380 (complete Screener preset guide — all 8 presets with exact criteria and IC use cases), Performance improvement (initIOCExposureControls deferred to idle), Accessibility improvement (aria-describedby + role=status on fc-status), v337→v338 structural sweep (378→380 FAQs). JS syntax gate PASS / 6 blocks / 0 JS errors.
