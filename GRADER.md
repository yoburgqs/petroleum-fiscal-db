...
| 5 | 2. Information Architecture | A+ | = | "Back to top" link at end of 128-FAQ section. Methodology card updated to 128 analyst FAQs (v225). First-visit Quick Start guide (v115). Landmark map complete (v104). |
...
| 8 | 10. Accessibility | A+ | = | IRR scatter chart aria-label fully descriptive (v120). All WCAG 2.1 AA landmarks complete. aria-live on #fc-status (v106). FAQ accordions A12–A128 accessible. FC sort row role=group (v112). Explorer aria-sort dynamic (v110). |
